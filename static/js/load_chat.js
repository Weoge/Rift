function loadChat(chatId, talker_username, talker_id) {
    ...
    const upper_chatHtml = `
        <div class="upper_chat bg">
            ...
            <div class="right">
                <button onclick="showProfile(${senderId}, ${chatId}); on_blur();" class="small" style="margin-right: 8px;">
                ...
                <button class="start small" style="margin-right: 3px;" onclick="startAudioCall()">
